...
/*   Updated: 2024/02/08 15:16:15 by plandolf         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ClapTrap::beRepaired(unsigned int amount)
{
	...
	std::cout <<  _name << " has been repaired by " << amount << " points!" << std::endl;
	_hitPoints += amount;
	std::cout <<  _name << " has now " << _hitPoints << " hit points left!" << std::endl;
	_energyPoints--;
	std::cout <<  _name << " has " << _energyPoints << " energy points left!\n" << std::endl;
}